...
namespace MonitorAgentService
{
    class RAIDClass
    {
        ...
        [DllImport("msvcrt.dll", EntryPoint = "memset", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl, SetLastError = false)]
        public static extern IntPtr MemSet(IntPtr dest, int c, int byteCount);
        
        [DllImport(@"Dlls\SSD_Raid64.dll", EntryPoint = "getPhyPortNVME", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool getPhyPortNVME64(int scsiPort, IntPtr phyPort, ref int raidType, ref int raidStatus);
        [DllImport(@"Dlls\SSD_Raid32.dll", EntryPoint = "getPhyPortNVME", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool getPhyPortNVME32(int scsiPort, IntPtr phyPort, ref int raidType, ref int raidStatus);

        [DllImport(@"Dlls\SSD_Raid64.dll", EntryPoint = "getNVMEIdSmart", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool getNVMEIdSmart64(int scsiPort, int scsiTargetId, IntPtr id, IntPtr smart, ref ulong disksize);
        
        [DllImport(@"Dlls\SSD_Raid32.dll", EntryPoint = "getNVMEIdSmart", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"Dlls\SSD_Raid64.dll", EntryPoint = "getPhyPort", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool getPhyPort64(int scsiPort, ref CSMI_SAS_PHY_INFO csni_sas_phy_info);
        [DllImport(@"Dlls\SSD_Raid32.dll", EntryPoint = "getPhyPort", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool getPhyPort32(int scsiPort, ref CSMI_SAS_PHY_INFO csni_sas_phy_info);

        [DllImport(@"Dlls\SSD_Raid64.dll", EntryPoint = "getIdSmart", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
        public static extern bool getIdSmart64(int scsiPort, int Phy, int Identify, IntPtr address, IntPtr id, IntPtr snart);
        [DllImport(@"Dlls\SSD_Raid32.dll", EntryPoint = "getIdSmart", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Cdecl)]
